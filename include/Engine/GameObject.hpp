...
public:
    ...
    inline void SetPosition(Vector value) {
        *m_position = value;
    };
    inline void SetZoomProportion(Vector value) {
        *zoomProportion = value;
    };
    inline int GetWidth() {
        return m_width;
    };
    ...
    inline Vector *GetZoomProportion() {
    ...
    inline Uint8 GetLayer() {
        return m_componentLayer;
    };
    Vector GetVelocity();
